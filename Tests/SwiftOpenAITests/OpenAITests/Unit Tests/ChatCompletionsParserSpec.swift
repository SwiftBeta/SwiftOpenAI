...
final class ChatCompletionParserSpec: XCTestCase {
    ...
    func testAsyncAPIRequest_ParsesValidJSONToChatCompletionsDataModel() async throws {
        ...
        let urlRequest = createRequest(model: .gpt4(.base), jsonData: jsonData, statusCode: 200)
    ...
    func testAsyncAPIRequest_ParsesValidErrorJSONToErrorDataModel() async throws {
        ...
        let urlRequest = createRequest(model: .gpt4(.base), jsonData: jsonData, statusCode: 401)
    ...
    private func createRequest(model: OpenAIModelType, jsonData: Data, statusCode: Int) -> URLRequest {
